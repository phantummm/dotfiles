...
alias klob='pushd ~/s/apps/apps/employers && RAILS_ENV=test bin/vite clobber && popd'
alias snappy='UPDATE_SNAPSHOTS=true bin/rspec'
alias rdbrb='bin/rails db:rollback:tenant_one && bin/rails db:rollback:common'
